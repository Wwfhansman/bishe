...
BARGE_IN_MIN_SPEECH_MS = int(env("BARGE_IN_MIN_SPEECH_MS", "1000"))
BARGE_IN_START_FRAMES = int(env("BARGE_IN_START_FRAMES", "15"))
...
BARGE_IN_FALLBACK_SENSITIVITY = int(env("BARGE_IN_FALLBACK_SENSITIVITY", "0"))
...
BARGE_IN_TTS_COOLDOWN_MS = int(env("BARGE_IN_TTS_COOLDOWN_MS", "500"))
...
BARGE_IN_PENDING_SCORE = float(env("BARGE_IN_PENDING_SCORE", "1.15"))
BARGE_IN_CONFIRM_SCORE = float(env("BARGE_IN_CONFIRM_SCORE", "1.45"))
